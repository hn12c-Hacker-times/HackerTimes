...
urlpatterns = [
    ...
    path('favorite-news/<int:pk>/', FavoriteNewsViewSet.as_view({'post': 'create', 'delete': 'destroy','get': 'retrieve'}), name='favorite-news-detail'),
    path('favorite-comments/', FavoriteCommentsViewSet.as_view({'get': 'list'}), name='favorite-comments-list'),
    path('favorite-comments/<int:pk>/', FavoriteCommentsViewSet.as_view({'post': 'create', 'delete': 'destroy','get': 'retrieve'}), name='favorite-comments-detail'),
